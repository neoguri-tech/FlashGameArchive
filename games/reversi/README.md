...
- 착수 기록과 실시간 점수
- 뒤집힘/착수 모션
- VS 컴퓨터/로컬 2인용 카오스 카드 모드
- 숨김 초능력/특수돌 카드, 공개 배너, 특수돌 고유 문양
- 로그인된 VS 컴퓨터 결과 저장
- VS 컴퓨터 최고 승리 리더보드
...
카오스 카드 모드는 로비의 `특수 룰`에서 켤 수 있습니다. 시작 시 흑/백이 같은 티어 합계의 초능력 1장과 특수돌 1장을 받고, 상대 카드는 사용 전까지 숨겨집니다. 현재 카오스 카드는 VS 컴퓨터와 로컬 2인에서만 켜며, 온라인 대전은 특수돌/카드 상태 직렬화를 붙인 뒤 활성화하는 편이 안전합니다.
